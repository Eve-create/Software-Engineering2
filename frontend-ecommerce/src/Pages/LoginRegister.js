...
function LoginRegister() {
  ...
  function register(event) {
    ...
    axios
      ...
      .then(() => {
        localStorage.setItem('welcomeMessage', `✅ Welcome to LleraMart, ${username}!`);
        navigate('/home');
      })
    ...
    axios
      ...
      .then((res) => {
        if (res.data.Status === 'Success') {
          localStorage.setItem('welcomeMessage', `✅ Welcome back to LleraMart, ${values.email}!`);
          navigate('/home');
        } else {
      ...
      >
        ...
        <div className='col-md-6 right-box'>
          <form onSubmit={login}>
            ...
            <div className='input-group mb-3 justify-content-center'>
              <button className='btn border-white text-white w-50 fs-6'>Log in</button>
            </div>
          </form>
        </div>
